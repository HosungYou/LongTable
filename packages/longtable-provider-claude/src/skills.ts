...
function baseSkillSpecs(surface: LongTableSkillSurface = "compact"): ClaudeSkillSpec[] {
  const specs = [
    ...
    },
    {
      ...
      description: "Compatibility alias for `$longtable-interview` critical mode.",
    ...
    },
    {
      ...
      description: "Use for `$longtable-interview`: run the unified LongTable interview surface, including option-first follow-up after a usable Research Specification and critical/grill-me pressure testing when requested.",
      triggers: ["$longtable-interview", "longtable interview", "follow-up research interview", "research specification interview"],
      body: [
        "## Purpose",
        "",
        "Run the unified LongTable interview inside Claude Code. It handles structured follow-up decisions after a usable Research Specification exists and critical pressure-testing when the researcher asks to be grilled.",
        "",
        "## Required Routing",
        "",
