...
function baseSkillSpecs(surface: LongTableSkillSurface = "compact"): CodexSkillSpec[] {
  const base = [
    ...
    },
    {
      ...
      description:
        "Use for `$longtable-interview`: create or continue a LongTable research-start interview inside Codex, then store a First Research Shape and Research Specification through MCP/state.",
      body: [
        "## Purpose",
        "",
